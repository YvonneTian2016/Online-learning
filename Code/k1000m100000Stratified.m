...
m = 100000;% online update slot
alpha = 0.7;


[off_sq_sample,sq1,sample_num] = Sample2D_Stratified(gI,N-k,u,v,u_cdf,v_cdf); 
off_sq = cat(2,off_sq,sq1');
...
imshow(image);
save('imageK1000M100000.mat','image');

savefig(GaussFig,'GaussK1000M100000.fig');
savefig(ResultFig,'ResultK1000M100000.fig');
